...
data_train = "datasets/HatemojiBuild-train.csv"
data_test = "datasets/HatemojiBuild-test.csv"
data_val = "datasets/HatemojiBuild-validation.csv"
...
class HateSpeechDetector:
    ...
    def train(self, train_df, val_df, text_column, label_column, epochs=20):
        ...
        callbacks = [
            ...
            tf.keras.callbacks.ReduceLROnPlateau(
                monitor="val_loss", factor=0.2, patience=3, min_lr=5e-7
            ),
        ]
    ...
    def evaluate(self, test_df, text_column, label_column):
        ...
        y_probs = np.array(np.array([prob[1] for prob in all_probs]))
        ...
        metrics = {
            ...
            "roc_auc": roc_auc_score(true_labels, y_probs),
        }
...
if __name__ == "__main__":
    ...
    # # Load test data
    # test_texts = pd.read_csv(data_test)["text"]
    ...
    # # Print predictions
    # label_map = {0: "Neutral", 1: "Hate Speech"}
    # true_labels = pd.read_csv(data_test)["label"]
    # for text, processed_test_texts, label, prob, true_label in zip(
    #     test_texts, processed_test_texts, predictions, probabilities, true_labels
    # ):
